...
const MARFA_CONFIG = {
  ...
  hero: {
    ...
    video_src: "/assets/hero-marfa.mp4",
  ...
  experiences: {
    ...
    items: [
      ...
      },
      {
        ...
        cta_label: "Ver Camping VIP",
        section_href: "#camping",
      ...
      },
      {
        ...
        cta_label: "Ver nuestros asadores",
        section_href: "#asadores",
  ...
  // ── ASADORES ───────────────────────────────────────────────────────────────
  asadores: {
    eyebrow: "Asadores MARFA",
    headline: "El asado que",
    headline_italic: "todos están esperando.",
    subline: "7 churrasqueros privados rodeados de naturaleza. Elige el tuyo y organiza la reunión perfecta.",
    cta_reserve: "Reservar un asador →",
    items: [
      {
        id: "c1",
        number: "01",
        name: "Churrasquero C1",
        cover: "c1-cover.jpg",
        photos: ["c1-cover.jpg", "c1-2.jpg", "c1-3.jpg"],
      },
      {
        id: "c2",
        number: "02",
        name: "Churrasquero C2",
        cover: "c2-cover.jpg",
        photos: ["c2-cover.jpg", "c2-2.jpg"],
      },
      {
        id: "c3",
        number: "03",
        name: "Churrasquero C3",
        cover: "c3-cover.jpg",
        photos: ["c3-cover.jpg"],
      },
      {
        id: "c4",
        number: "04",
        name: "Churrasquero C4",
        cover: "c4-cover.jpg",
        photos: ["c4-cover.jpg", "c4-2.jpg"],
      },
      {
        id: "c5",
        number: "05",
        name: "Churrasquero C5",
        cover: "c5-cover.jpg",
        photos: ["c5-cover.jpg", "c5-2.jpg"],
      },
      {
        id: "c6",
        number: "06",
        name: "Churrasquero C6",
        cover: "c6-cover.jpg",
        photos: ["c6-cover.jpg", "c6-2.jpg", "c6-3.jpg"],
      },
      {
        id: "c7",
        number: "07",
        name: "Churrasquero C7",
        cover: "c7-cover.jpg",
        photos: ["c7-cover.jpg", "c7-2.jpg"],
      },
    ],
  },
  ...
  // ── CAMPING VIP ────────────────────────────────────────────────────────────
  camping: {
    eyebrow: "Camping VIP · MARFA",
    headline: "Duerme bajo",
    headline_italic: "las estrellas.",
    description: "Un campamento equipado en medio de la naturaleza. Despierta con el sonido de los árboles, la brisa de la laguna y nada más que el cielo sobre ti. MARFA ofrece espacios de Camping VIP con todo lo que necesitas para una noche (o varias) que no olvidarás.",
    features: [
      {
        icon: "🌿",
        title: "Espacios privados",
        desc: "Cada lugar de camping tiene su propio espacio y privacidad dentro de las 19 hectáreas.",
      },
      {
        icon: "🌊",
        title: "A metros de la laguna",
        desc: "Amanece con vistas al agua. La laguna natural de MARFA es el mejor vecino que puedes tener.",
      },
      {
        icon: "🔥",
        title: "Asadores disponibles",
        desc: "Combina tu estadía con el alquiler de un churrasquero para la cena perfecta al aire libre.",
      },
    ],
    cta_label: "Reservar Camping VIP →",
    cover: "camping-cover.jpg",
    photo2: "camping-2.jpg",
  ...
  // ── PROPERTY MAP ───────────────────────────────────────────────────────────
  property_map: {
    eyebrow: "Mapa de la propiedad",
    headline: "Explora",
    headline_italic: "MARFA.",
    subline: "19 hectáreas organizadas para que vivas la experiencia que quieras. Conoce dónde está cada espacio antes de llegar.",
  },

  // ── LOCATION ───────────────────────────────────────────────────────────────
  location: {
    eyebrow: "Cómo llegar",
    headline: "Encuéntranos en",
    headline_italic: "el mapa.",
    subline: "Estamos en Bolivia. Abre Google Maps en tu teléfono y te guiamos hasta aquí.",
    address: "Marfa Camping y Pesca\nBolivia",
    lat: -17.3848666,
    lng: -63.1671478,
    embed_url: "https://maps.google.com/maps?q=-17.3848666,-63.1671478&z=16&output=embed&hl=es",
    maps_url: "https://www.google.com/maps/place/Marfa+Camping+y+Pesca/@-17.3848666,-63.1697227,1009m/data=!3m2!1e3!4b1!4m6!3m5!1s0x93ee175cc66a2943:0xdec2f873bdd9f792!8m2!3d-17.3848666!4d-63.1671478!16s%2Fg%2F11y6p4c8k_",
    features: [
      "19 hectáreas de naturaleza",
      "Laguna natural propia",
  ...
  // ── VIRTUAL TOUR 360° ──────────────────────────────────────────────────────
  // Fase 2 (ver TRD.md §6): navegación real entre escenas vía hotspots.
  // Escenas y coordenadas de muestra (demo oficial de Photo Sphere Viewer,
  // "Cape Florida Light, Key Biscayne" — Pixexid) — SOLO para validar la técnica.
  // Reemplazar `nodes` por fotos 360 reales de MARFA y sus propios yaw/pitch
  // marcados a mano (ver TRD.md §6.2) antes de lanzar a producción.
  virtual_tour: {
    eyebrow: "Paseo Virtual 360°",
    headline: "Camina MARFA",
    headline_italic: "sin salir de casa.",
    start_node_id: "1",
    nodes: [
      {
        id: "1",
        name: "Escena 1 (muestra)",
        ...
        caption: "Escena de muestra 1 — reemplazar por foto real de MARFA",
        sphereCorrection: { pan: "33deg" },
        links: [{ nodeId: "2", position: { pitch: 0, yaw: "100deg" } }],
      },
      {
        id: "2",
        name: "Escena 2 (muestra)",
        ...
        caption: "Escena de muestra 2 — reemplazar por foto real de MARFA",
      ...
      },
      {
        ...
        caption: "Escena de muestra 3 — reemplazar por foto real de MARFA",
      ...
      },
      {
        ...
        caption: "Escena de muestra 4 — reemplazar por foto real de MARFA",
      ...
      },
      {
        ...
        caption: "Escena de muestra 5 — reemplazar por foto real de MARFA",
      ...
      },
      {
        ...
        caption: "Escena de muestra 6 — reemplazar por foto real de MARFA",
      ...
      {
        id: "7",
        name: "Escena 7 (muestra)",
        panorama: "https://photo-sphere-viewer-data.netlify.app/assets/tour/key-biscayne-7.jpg",
        thumbnail: "https://photo-sphere-viewer-data.netlify.app/assets/tour/key-biscayne-7-thumb.jpg",
        caption: "Escena de muestra 7 — reemplazar por foto real de MARFA",
